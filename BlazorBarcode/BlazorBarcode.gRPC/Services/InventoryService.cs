	...
	public class InventoryService : Inventory.InventoryBase
	{
		...
		{			
			...
			return new ProductResponse
			{
				Product = new Product()
				{
					EAN = existingProduct == null ? request.EAN : existingProduct.BarcodeNo,
					Name = existingProduct == null ? "There is none" : existingProduct.ProductName,
					Description = existingProduct == null ? string.Empty : existingProduct.Description
				}
			};
